...
class MainActivity : AppCompatActivity() {
    ...
    private val overlayPermissionLauncher = registerForActivityResult(
        ...
        if (checkOverlayPermission()) requestMediaProjection()
        else Toast.makeText(this, "Izin Tampilan di Atas Aplikasi Lain Diperlukan", Toast.LENGTH_LONG).show()
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnPlay.setOnClickListener {
            if (!checkOverlayPermission()) requestOverlayPermission() else requestMediaProjection()
        }
    }
