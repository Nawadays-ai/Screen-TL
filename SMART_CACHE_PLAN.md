...
- [TEMUAN BARU] `FloatingService.toOverlayItem()` tidak meneruskan `orientation`, sedangkan `KlipSelectionController.toOverlayItem()` meneruskannya. Jadi overlay Manual dan Real-Time memperlakukan teks vertikal Jepang sebagai horizontal. Belum diperbaiki karena mengubah perilaku render.
